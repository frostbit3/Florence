...
public class LogoutPacketBuilder extends PacketBuilder {

    public LogoutPacketBuilder() {
        super(PacketBuilderConstants.LOGOUT_USER_PACKET_OPCODE, PacketHeader.FIXED);
    }
